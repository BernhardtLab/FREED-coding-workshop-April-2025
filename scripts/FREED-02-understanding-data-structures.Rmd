...
###NOTE TO SELF : this is not presently working. I can get this to work for the github just fine, but will need to coordinate with Amanda on the file directory we are expecting students to set up
...
####is it because youre not evaluating (or including) them? - A 
