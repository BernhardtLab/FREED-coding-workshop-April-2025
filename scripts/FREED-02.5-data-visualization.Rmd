...
```{r}
americas$country.fac <- fct_relevel(americas$country.fac, "Canada", "Cuba", "Dominican Republic", "Haiti", "Jamaica", "Mexico",  "Puerto Rico", 
                                    "Trinidad and Tobago", "United States","Costa Rica", "El Salvador", "Guatemala", "Honduras", "Nicaragua", "Panama",
